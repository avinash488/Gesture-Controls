...
class HandDetector:
    ...
    def findHands(self, img):
        if img is None or img.size == 0:  # ⚠️ safeguard
            return img
...
def main():
    ...
    if not cap.isOpened():
        print("❌ Camera not detected. Try cap = cv2.VideoCapture(1)")
        return
    ...
    while True:
        ...
        if not success or img is None:  # ⚠️ safeguard
        ...
        # --- (rest of your existing keyboard logic unchanged) ---
